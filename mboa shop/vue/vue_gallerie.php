...
<head>
	...
	<title>MBOA SHOP Online: Gallerie </title>
</head> 
<body>
	...
	<section class="section"> 
		...
		<h2> Gallerie </h2>
			...
			<form method="post" action="index.php?un=gallerie#liens" id="liens">
				<label>Couleur</label>
		...
		<div class="pagination">
			...
			<?php   for ($i=1; $i <= $pageTotales ; $i++) {
						...
						if ($i == $pageCourante) {
							...
							echo '<button><a href="index.php?un=gallerie&page='.$i.'#liens"> '.$i.' </a></button>   ';
						}
					}
			?> 
